...
const initialHomeData = {
  ...
  heroText: `أنا فني ومقاول تشطيبات وديكور ماهر ودقيق، أتمتع بخبرة تمتد لأكثر من 37 في تقديم حلول تشطيبات داخلية وخارجية عالية الجودة. متخصص في الطلاء، التبليط، النجارة، الأعمال الكهربائية، السباكة، الجبس بورد، وتركيبات الـ جي أر سي. لدي سجل حافل بإتمام المشاريع في الوقت المحدد وضمن الميزانية وبأعلى معايير الحرفية.
...
const initialAboutData = {
  profileImage: "/profile/WhatsApp Image 2025-01-17 at 21.27.48_0a98b0ea.jpg",
  name: "يحى محمود",
  background: `أنا فني ومقاول تشطيبات وديكور ماهر ودقيق، أتمتع بخبرة تمتد لأكثر من 37 في تقديم حلول تشطيبات داخلية وخارجية عالية الجودة. متخصص في الطلاء، التبليط، النجارة، الأعمال الكهربائية، السباكة، الجبس بورد، وتركيبات الـ جي أر سي. لدي سجل حافل بإتمام المشاريع في الوقت المحدد وضمن الميزانية وبأعلى معايير الحرفية.
أتميز بخبرة في اختيار المواد وإدارة الفرق وحل المشكلات بطرق مبتكرة، مما يضمن تنفيذ المشاريع بسلاسة مع التركيز على رضا العملاء. هدفي هو تحويل المساحات إلى بيئات وظيفية وجمالية مع الحفاظ على الكفاءة في التكلفة والاستدامة والعناية بالتفاصيل.
`,
  qualifications: [
